...
with col2:
    ...
    try:
        ...
        # Side-by-side: Today's Summary + Export Tool
        summary_col1, summary_col2, export_col = st.columns([1, 1, 1.5])
        ...
        with export_col:
            st.write("📥 **Export Daily Report**")
            selected_day = st.date_input("Day:", key="export_date", label_visibility="collapsed")
